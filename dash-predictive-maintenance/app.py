...
df,df_button,x_test,y_test,x_train=data_preprocessing.data_prepocessing()


def logo(app):
    title=html.H5('PREDICTIVE MAINTENANCE DASHBOARD FOR WIND TURBINES',
                  style={'marginTop':5,'marginLeft':'10px'})
    info_about_app=html.H6('This dashboard is focused on estimating the Remaining Useful Life (RUL) in wind turbines,'
                           'RUL is defined as the time until next fault.',
                           style={'marginLeft':'10px'})
    logo_image=html.Img(src=app.get_asset_url('dash-logo.png'),
...
predict_button=dbc.Card(className='mt-auto',
                        children=[dbc.CardBody([html.Div([dbc.Button('Predict',
                                                              id='predict-button',
                                                              color='primary',
                                                               outline=True,
                                                              size='lg',
...
get_new_information_button=dbc.Card(className='mt-auto',
                                    children=[dbc.CardBody([html.Div([dbc.Button('Get New Data',
...
rul_estimation_indicator=dbc.Card(children=[dbc.CardHeader('System RUL Estimation (days)',
                   style={'color':'white',
                          'text-align':'center',
                          'backgroundColor':'black',
                          'border-radius':'1px',
    ...
    dbc.CardBody([daq.LEDDisplay(id='rul-estimation-indicator-led',
                                 size=24,
                                 color='#fec036',
                                 style={'color':'#black'},
...
info_box=dbc.Card(children=[
    dbc.CardBody([
        html.Div(dcc.Textarea(id='Info-Textbox',
    ...
    style={'backgroundColor':'black',
           'border-radius':'1px',
           'border-width':'5px',
           'top-border':'1px solid rgb(216,216,216)'})
])

graph=dbc.Card(children=[
    dbc.CardBody([html.Div([dcc.Graph(id='Main-Graph',
                                      figure={
                                          'layout':{
                  ...
                  html.Div([dcc.Dropdown(id='feature-dropdown',
                  ...
                  html.Div([dcc.DatePickerRange(id='date-picker',
                                                min_date_allowed=x_train.index[0],
...
blade_angle_display=dbc.Card(className='mt-auto',
                             children=[dbc.CardHeader('Blade Angle',
                                                      style={
                                                          'text-align':'center',
                                                          'color':'white',
                                                          'backgroundColor':'black',
                                       ...
                                       dbc.CardBody([html.Div(daq.Gauge(id='blade-angle-information-gauge',
                                                              min=min(df['WEC: ava. blade angle A']),
                                                              max=max(df['WEC: ava. blade angle A']),
                                                              value=0,
...
active_power_display=dbc.Card(className='mt-auto',
                             children=[dbc.CardHeader('Active Power [kW]',
                                                      style={
                                                          'text-align':'center',
                                                          'color':'white',
                                                          'backgroundColor':'black',
                                       ...
                                       dbc.CardBody([
                                           html.Div(daq.Gauge(id='active-power-information-gauge',
                                                              min=min(df['WEC: ava. Power']),
                                                              max=max(df['WEC: ava. Power']),
                                                              value=0,
                                                              showCurrentValue=True,
                                                              color='#fec036',
                                                              style={'align':'center',
...
active_power_from_wind_display=dbc.Card(className='mt-auto',
                             children=[dbc.CardHeader('Active Power Available from Wind [kW]',
                                                      style={
                                                          'text-align':'center',
                                                          'color':'white',
                                                          'backgroundColor':'black',
                                       ...
                                       dbc.CardBody([
                                           html.Div(daq.Gauge(id='active-power-from-wind-information-gauge',
...
wind_speed_information=dbc.Card(className='mt-auto',
                             children=[dbc.CardHeader('Wind Speed [m/s]',
                                                      style={
                                                          'text-align':'center',
                                                          'color':'white',
                                                          'backgroundColor':'black',
                                                          ...
                                                          'border-top':'1px solid rgb(216,216,216)'}),
                                       dbc.CardBody([
                                           html.Div(daq.Gauge(id='wind-power-information-gauge',
                                                              min=min(df['WEC: ava. windspeed']),
                                                              max=max(df['WEC: ava. windspeed']),
                                                              value=0,
                                                              showCurrentValue=True,
                                                              color='#fec036',
                                                              style={'align':'center',
...
reactive_power_display=dbc.Card(className='mt-auto',
                             children=[dbc.CardHeader('Reactive Power [kVAR]',
                                                      style={
                                                          'text-align':'center',
                                                          'color':'white',
                                                          'backgroundColor':'black',
                                       ...
                                       dbc.CardBody([
                                           html.Div(daq.Gauge(id='reactive-power-information-gauge',
...
def fig_update_layout(fig):
    fig.update_layout(xaxis=dict(showgrid=False,
                      ...
                      paper_bgcolor="black",
                      plot_bgcolor="black",
                      title=dict(font=dict(family='Arial',size=32,color='darkgray'),
                                 xanchor='center',
                                 yanchor='top',
                                 y=1,
                                 x=0.5))
        ...
        if n_get_new_info is None:
            if selected_column in list(df):
                if start_date and end_date:
                    ...
                    df_within_data=df.loc[mask]
                    fig=go.Figure(
                        data=[
                            go.Scatter(x=df_within_data.index,
                                       y=df_within_data[selected_column])
                        ]
                    )
                    fig=fig_update_layout(fig)
                    return fig, val_rul,information_update
                    ...
                    fig=go.Figure(data=[
                        go.Scatter(x=df_within_dates.index,
                    ...
                    fig=fig_update_layout(fig)
                    return fig,val_rul,information_update
            else: #如果所选的feature不在dataframe中
                fig=go.Figure(data=[
                    go.Scatter(x=df.index,
                               y=df['WEC: ava. windspeed'])
                ])
                fig=fig_update_layout(fig)
                return fig,val_rul,information_update
        else: #如果单击了 n_get_new_info 按钮
            ...
            if selected_column is list(df_button):
                fig=go.Figure(data=[
                ...
                fig=fig_update_layout(fig)
                return fig,val_rul,information_update
            else: #所选column不在df_button中
                fig=go.Figure(data=[
                    go.Scatter(x=df_button.index,
                               y=df_button['WEC: ava. windspeed'])
                ])
                fig=fig_update_layout(fig)
                return fig,val_rul,information_update
    else: #如果单击了Predict的按钮
        if n_get_new_info is None: # 没有单击获取新数据的按钮
            val_rul=0.0
            ...
            if selected_column in list(df):
                if start_date and end_date:
                    ...
                    df_within_dates=df.loc[mask]
                    fig=go.Figure(data=[
                        go.Scatter(x=df_within_dates.loc[mask],
                                   y=df_within_dates[selected_column])
                    ])
                    fig=fig_update_layout(fig)
                    return fig,val_rul,information_update
...
def display_click_data(clickData):
    if clickData:
        date_time=clickData['points'][0]['x']

        value_active_power=df['WEC: ava. Power'].loc[df.index==date_time].values[0]
        value_active_power_wind=df['WEC: ava. available P from wind'].loc[df.index==date_time].values[0]
        value_reactive_power=df['WEC: ava. reactive Power'].loc[df.index==date_time].values[0]
        value_wind_speed=df['WEC: ava. windspeed'].loc[df.index==date_time].values[0]
        value_blade_angle=df['WEC: ava. blade angle A'].loc[df.index==date_time].values[0]
        return (value_active_power,
